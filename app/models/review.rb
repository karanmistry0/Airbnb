class Review < ApplicationRecord
  ...
  def update_overall_rating
    avg_rating = cleanliness_rating + accuracy_rating + checkin_rating + value_rating + location_rating + communication_rating
    update_column(:overall_rating,avg_rating.to_f/6)
