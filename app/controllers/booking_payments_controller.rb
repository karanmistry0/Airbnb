class BookingPaymentsController < ApplicationController
  def create
    ...
    success_url = url_for(controller: 'booking_payments',action: 'success',only_path: false,booking_params:booking_payments_params)
  ...
  def success
    ...
    reservation = Reservation.create!(
      ...
      check_in: booking_params[:checkin_date],
      check_out: booking_params[:checkout_date]
    )
