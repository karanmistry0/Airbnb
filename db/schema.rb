...
ActiveRecord::Schema[7.1].define(version: 2024_05_09_092230) do
  ...
  create_table "whislists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["property_id"], name: "index_whislists_on_property_id"
    t.index ["user_id", "property_id"], name: "index_whislists_on_user_id_and_property_id", unique: true
    t.index ["user_id"], name: "index_whislists_on_user_id"
  end
